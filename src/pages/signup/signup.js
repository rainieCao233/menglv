    ...
    return(
      <div id="signup">
        <div className="wrap">
          ...
          <div className="main">
            <div>*姓    名: <input type="text" /></div>
            <div>*昵    称: <input type="text" /></div>
            <div>*身份证号: <input type="text" /></div>
            <div>*手机号码: <input type="text" /></div>
            <div>*集合地点: linkageMenu</div>
            <a href="" className="signup_btn">增加报名人员</a>
            <div className="discount">
              <h4>可享受优惠促销套装</h4>
              <p>牧高迪T2铝杆双人帐篷</p>
              <p>【特价包邮】牧高迪T2铝杆帐篷一顶</p>
              <a href="" className="detail_btn">查看详情</a>
              <div className="price">
                <span>市场价：<b>¥298</b></span>
                <span><b>¥298</b>/份</span>
              </div>
              <div>计数器counter插件</div>
            </div>
            <div className="discount">
              <h4>可享受优惠促销套装</h4>
              <p>牧高迪T2铝杆双人帐篷</p>
            ...
            <div className="discount">
              ...
              <div>继续预定代表您已经阅读并同意<a href="">预订须知</a></div>
            </div>
            <div className="total">
              总价 : <b>¥569</b>可获积分 : 569
              <a href="">提交订单</a>
