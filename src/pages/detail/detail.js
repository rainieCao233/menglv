          ...
          <div className="intro_wrap clearfix">
            ...
            <div className="intro">
              ...
              <ul>
                ...
                <li>活动类型 : {this.state.types.length>0?this.state.types[0].type:""}</li>
                <li>活动地点 : {this.state.activity.destination?this.state.activity.destination:""}</li>
                <li>集合地点 : {this.state.meetingPlaces.length>0?this.state.meetingPlaces[0].placeName:""}</li>
                <li>集合时间 : {this.state.activity.meetingTime?this.state.activity.meetingTime:""}</li>
                <li>活动人数 : {this.state.pnum?this.state.pnum:0}/{this.state.activity.maxPeople?this.state.activity.maxPeople:""} (已报名 / 人数上限)</li>
                <li>活动领队 : {this.state.leaders.length>0?this.state.leaders[0].name:""} <a href="javascript:void(0);"  style={{display:this.state.leaders.length>0?"inline-block":"none"}} onClick={this.showLeader}>查看领队介绍</a></li>
                <li><a href="javascript:void(0);" onClick={this.showModal}>点击查看报名须知</a></li>
              </ul>
