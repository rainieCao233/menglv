...
var Detail = React.createClass({
  ...
  render:function(){
    console.log(this.state.meetingPlaces[0]?this.state.meetingPlaces[0].placeName:"");
    console.log(this.state.meetingPlaces[0].placeName?this.state.meetingPlaces[0].placeName:"");
    return(
